...
fn call_3526501959(js: Arc<JS>, v:Vec<JSType>) -> Option<CallResult>{
	...
	let jst2 = &v[2];
    let ptr = jstype_ptr(&jst2, js.clone(), 1411051473, true, param_error).expect("");
...
fn drop_3367212459(ptr: usize){
    unsafe { Box::from_raw(ptr as *mut Vec<pi_lib::atom::Atom>) };
}
...
pub fn register(mgr: &BonMgr){
    ...
    mgr.regist_struct_meta(StructMeta{name:String::from("Vec<pi_lib::atom::Atom>"), drop_fn: drop_3367212459}, 3367212459);
