                    ...
                    Box::new(move |js: Arc<JS>| {
                        let mut r = match r {
                            Some(v) => {
                                ...
                                let mut v_elem =
                                    ptr_jstype(js.get_objs(), js.clone(), ptr, 2886438122);
            ...
            Ok(r) => {
                let mut r = match r {
                    Some(v) => {
                        ...
                        let mut v_elem = v.0;
                        let ptr = Box::into_raw(Box::new(v_elem)) as usize;
                        let mut v_elem = ptr_jstype(js.get_objs(), js.clone(), ptr, 2886438122);
...
fn call_1993779671(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = match result {
        Ok(r) => {
            ...
            let mut r = ptr_jstype(js.get_objs(), js.clone(), ptr, 2627601653);
...
fn call_4117819797(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_db::DBToGlobalMqttMonitor::new(jst0);
    let mut result = match result {
        Ok(r) => {
            let ptr = Box::into_raw(Box::new(r)) as usize;
            let mut r = ptr_jstype(js.get_objs(), js.clone(), ptr, 1632158050);
...
fn call_2153620660(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 1495847839);
        ...
        let mut r = match r {
            Ok(r) => {
                block_reply(
                    ...
                    Box::new(move |js: Arc<JS>| {
                        let ptr = Box::into_raw(Box::new(r)) as usize;
                        let mut r = ptr_jstype(js.get_objs(), js.clone(), ptr, 3289224548);
                    }),
...
fn call_1420275781(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 2976191628);
...
fn call_1905006775(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = js.new_boolean(result);
...
fn call_2215620835(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_db::register_file_mem_db(jst0, jst1, jst2);
    let mut result = js.new_boolean(result);
...
fn call_360427781(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 1542823015);
...
fn call_2573413979(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 104530634);
...
fn call_2097131752(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 4000136370);
...
fn call_1579404380(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = match result {
        Some(v) => {
            ...
            let mut v = ptr_jstype(js.get_objs(), js.clone(), ptr, 2886438122);
...
fn call_2986122496_sync(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let jscopy = js.clone();
    let call_back = move |r: Result<usize, String>| {
        let mut r = match r {
            Ok(r) => {
                block_reply(
                    jscopy.clone(),
                    Box::new(move |js: Arc<JS>| {
                        let mut r = js.new_u32(r as u32);
                    }),
...
fn call_1263843384(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_vm::get_byte_code(jst0);
    let mut result = match result {
        Some(v) => {
            let ptr = v as *const Vec<u8> as usize;
            let mut v = ptr_jstype(js.get_objs_ref(), js.clone(), ptr, 104530634);
    ...
    let call_back = move |r: Result<&'static Vec<u8>, String>| {
        push_callback(
            ...
            Box::new(move |js: Arc<JS>| {
                let mut r = match r {
                    Ok(r) => {
                        let ptr = r as *const Vec<u8> as usize;
                        let mut r = ptr_jstype(js.get_objs_ref(), js.clone(), ptr, 104530634);
            ...
            None,
            Atom::from("call_3830865479_async1"),
        );
    };
...
fn call_2450233359(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_vm::compile_sync(jst0, jst1);
    let mut result = match result {
        Some(v) => {
            let ptr = v as *const Vec<u8> as usize;
            let mut v = ptr_jstype(js.get_objs_ref(), js.clone(), ptr, 104530634);
...
fn call_4192708231(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_env::Args::next(jst0);
    let mut result = match result {
        Some(v) => {
            let mut v = js.new_str(v).unwrap();
            v
        }
        None => js.new_null(),
    };
...
fn call_2544700472(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_env::EnvVars::next(jst0);
    let mut result = match result {
        Some(v) => {
            let array = js.new_array();
            let mut v_elem = v.0;
            let mut v_elem = js.new_str(v_elem).unwrap();
            js.set_index(&array, 0, &mut v_elem);
            let mut v_elem = v.1;
            let mut v_elem = js.new_str(v_elem).unwrap();
            js.set_index(&array, 1, &mut v_elem);
...
fn call_692858595(js: Arc<JS>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 1694133887);

    Some(CallResult::Ok)
}

fn call_76907791(js: Arc<JS>) -> Option<CallResult> {
    let result = js_env::current_dir();
    let mut result = match result {
        Ok(r) => {
            let mut r = js.new_str(r).unwrap();
            r
        }
        Err(v) => {
            return Some(CallResult::Err(v + ", Result is Err"));
...
fn call_3151666217(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_env::set_current_dir(jst0);
    let mut result = match result {
        Ok(r) => {
            let array = js.new_array();
            let mut r = array;
...
fn call_341310298(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_env::env_var(jst0);
    let mut result = match result {
        Ok(r) => {
            let mut r = js.new_str(r).unwrap();
            r
...
fn call_2758093424(js: Arc<JS>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 591726708);
        ...
        push_callback(
            ...
            Box::new(move |js: Arc<JS>| {
                let mut r = match r {
                    Ok(r) => {
                        let ptr = Box::into_raw(Box::new(r)) as usize;
                        let mut r = ptr_jstype(js.get_objs(), js.clone(), ptr, 104530634);
            ...
            None,
            Atom::from("call_215229799_async1"),
        );
    };
...
fn call_3061910455_async(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let call_back = move |r: Result<String, String>| {
        push_callback(
            ...
            None,
            Atom::from("call_3061910455_async1"),
        );
    };
...
fn call_3728513126(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_file::read_file_buffer_sync(jst0);
    let mut result = match result {
        Ok(r) => {
            let ptr = Box::into_raw(Box::new(r)) as usize;
            let mut r = ptr_jstype(js.get_objs(), js.clone(), ptr, 104530634);
...
fn call_2674074487(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_file::read_file_string_sync(jst0);
    let mut result = match result {
        Ok(r) => {
            let mut r = js.new_str(r).unwrap();
            r
...
fn call_3649129955(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_file::walk_dir_sync(jst0);
    let mut result = match result {
        Ok(r) => {
            let ptr = Box::into_raw(Box::new(r)) as usize;
            let mut r = ptr_jstype(js.get_objs(), js.clone(), ptr, 1542823015);
...
fn call_1347190475(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = match result {
        Ok(r) => {
            let ptr = Box::into_raw(Box::new(r)) as usize;
            let mut r = ptr_jstype(js.get_objs(), js.clone(), ptr, 1846921536);
...
fn call_3993207385(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 730519735);
...
fn call_4111533257(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 374659923);
...
fn call_3741531906(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = ptr_jstype(js.get_objs_ref(), js.clone(), ptr, 104530634);
...
fn call_1810043215_sync(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let call_back = move || {
        block_reply(
            ...
            Atom::from("call_1810043215_sync"),
        );
    };
...
fn call_59144274(js: Arc<JS>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 3355421248);
...
fn call_3881780156(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = js.new_u32(result);
...
fn call_3908949488(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = js.new_u64(result);
...
fn call_1099259475(js: Arc<JS>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 1422904849);
...
fn call_1332820780(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_lib::Nobjs::set_obj(jst0, jst1, jst2, jst3, jst4, &js);
    let mut result = match result {
        Ok(r) => {
            let mut r = js.new_boolean(r);
            r
...
fn call_2697841501(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 2566315655);
...
fn call_691063210(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_lib::JSGray::set_obj(jst0, jst1, jst2, jst3, jst4, &js);
    let mut result = match result {
        Ok(r) => {
            let mut r = js.new_boolean(r);
            r
...
fn call_3635855143(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 3386914360);
...
fn call_3557646357(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = js.new_str(result.to_string()).unwrap();
    Some(CallResult::Ok)
}
...
fn call_3906048478(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_lib::bonbuf_cmp(jst0, jst1);
    let mut result = match result {
        Some(v) => {
            let mut v = js.new_i32(v);
            v
        }
        None => js.new_null(),
    };
...
fn call_373179692(js: Arc<JS>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 1131624585);
...
fn call_2011091417(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let jst5 = &v[5];
    if !jst5.is_uint8_array() && !jst5.is_array_buffer() {
        return Some(CallResult::Err(String::from(param_error)));
    }
    let arr = unsafe { *(jst5.to_bytes().as_ptr() as usize as *const [u8; 8]) };
    let jst5 = unsafe { transmute::<[u8; 8], u64>(arr) };
...
fn call_2175286088(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = match result {
        Some(v) => {
            let mut v = js.new_str(String::from(v.as_str())).unwrap();
            v
        }
        None => js.new_null(),
    };
...
fn call_1065006446(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = js.new_u32(result as u32);
...
fn call_1016322459(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 4139279264);
...
fn call_2344044784(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = match result {
        Ok(r) => {
            let ptr = Box::into_raw(Box::new(r)) as usize;
            let mut r = ptr_jstype(js.get_objs(), js.clone(), ptr, 4139279264);
...
fn call_794872933(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 3642917301);
...
fn call_997239765(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_httpc::create_http_client(jst0, jst1);
    let mut result = match result {
        Ok(r) => {
            let ptr = Box::into_raw(Box::new(r)) as usize;
            let mut r = ptr_jstype(js.get_objs(), js.clone(), ptr, 1107924793);
...
fn call_2282211344_sync(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let jscopy = js.clone();
    let call_back =
        move |r: Result<(Arc<httpc::HttpClient>, httpc::HttpClientResponse), String>| {
            let mut r = match r {
                Ok(r) => {
                    block_reply(
                        jscopy.clone(),
                        Box::new(move |js: Arc<JS>| {
                            ...
                            let mut r_elem = ptr_jstype(js.get_objs(), js.clone(), ptr, 1107924793);

                            js.set_index(&array, 0, &mut r_elem);
                            let mut r_elem = r.1;
                            let ptr = Box::into_raw(Box::new(r_elem)) as usize;
                            let mut r_elem = ptr_jstype(js.get_objs(), js.clone(), ptr, 606449873);

                            js.set_index(&array, 1, &mut r_elem);
                            let mut r = array;
                        }),
...
fn call_545958709(js: Arc<JS>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 2462173101);
...
fn call_471202658(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 4120821321);
...
fn call_1849109725(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 1707332364);
...
fn call_2637800921(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 15779622);
...
fn call_3844141423(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 2899437702);
...
fn call_3244057673(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 4208533229);
...
fn call_2248917003(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 2484911420);
...
fn call_3695051784(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 3913457295);
...
fn call_2867121613(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_net::unset_mqtt_topic(jst0, jst1);
    let mut result = match result {
        Ok(r) => {
            let array = js.new_array();
            let mut r = array;
...
fn call_1551231400(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_net::mqtt_publish(jst0, jst1, jst2, jst3, jst4);
    let mut result = match result {
        Ok(r) => {
            let array = js.new_array();
            let mut r = array;
...
fn call_527952504(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 3776892844);
...
fn call_2333272468(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 1562130667);
...
fn call_466468899(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 619541818);
...
fn call_466051911(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 259136547);
...
fn call_1942014446(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 3355816649);
...
fn call_2753091108(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = hotfix::GrayMgr::update_gray(jst0, jst1, jst2, jst3);
    let mut result = js.new_boolean(result);
...
fn call_2997074552(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = hotfix::GrayMgr::has_gray_tab(jst0, jst1);
    let mut result = js.new_boolean(result);
...
fn call_4222745849(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = hotfix::GrayMgr::get_gray_tab(jst0, jst1);
    let mut result = match result {
        Some(v) => {
            let ptr = Box::into_raw(Box::new(v)) as usize;
            let mut v = ptr_jstype(js.get_objs(), js.clone(), ptr, 3386914360);
...
fn call_1272018599(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = hotfix::GrayMgr::add_gray_tab(jst0, jst1);
    let mut result = match result {
        Ok(r) => {
            let array = js.new_array();
            let mut r = array;
...
fn call_2013391265(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = hotfix::GrayMgr::remove_gray(jst0, jst1);
    let mut result = js.new_boolean(result);
...
fn call_56672718(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = hotfix::GrayMgr::set_obj(jst0, jst1, jst2, jst3, jst4, &js);
    let mut result = match result {
        Ok(r) => {
            let mut r = js.new_boolean(r);
            r
...
fn call_3591490542(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 579352454);
...
fn call_451831207(js: Arc<JS>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 937567010);
...
fn call_3060877404(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let mut result = js.new_str(result).unwrap();
...
fn call_1752410735(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let result = js_net_rpc_client::RPCClient::create(jst0);
    let mut result = match result {
        Ok(r) => {
            let ptr = Box::into_raw(Box::new(r)) as usize;
            let mut r = ptr_jstype(js.get_objs(), js.clone(), ptr, 4088898725);
                ...
                let mut r = match r {
                    Ok(r) => {
                        let mut r = match r {
                            Some(v) => {
                                let ptr = Box::into_raw(Box::new(v)) as usize;
                                let mut v = ptr_jstype(js.get_objs(), js.clone(), ptr, 104530634);
...
fn call_146889029(js: Arc<JS>, v: Vec<JSType>) -> Option<CallResult> {
    ...
    let ptr = Box::into_raw(Box::new(result)) as usize;
    let mut result = ptr_jstype(js.get_objs(), js.clone(), ptr, 4288401962);
...
pub fn register(mgr: &BonMgr) {
    ...
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("mqtt_tmp::server::ServerNode"),
            drop_fn: drop_2484911420,
        },
        2484911420,
    );
    mgr.regist_struct_meta(
    ...
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_db::DBToGlobalMqttMonitor"),
            drop_fn: drop_1632158050,
        },
        1632158050,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_db::JSDBMonitor"),
            drop_fn: drop_1495847839,
        },
        1495847839,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("pi_db::db::Event"),
            drop_fn: drop_3165549746,
        },
        3165549746,
    );
    mgr.regist_struct_meta(
    ...
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("pi_store::lmdb_file::DB"),
            drop_fn: drop_568147534,
        },
        568147534,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("pi_store::file_mem_db::FileMemDB"),
            drop_fn: drop_2325173571,
        },
        2325173571,
    );
    mgr.regist_struct_meta(
    ...
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("Arc<pi_db::db::TabMeta>"),
            drop_fn: drop_4164638564,
        },
        4164638564,
    );
    mgr.regist_struct_meta(
    ...
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_db::DBWare"),
            drop_fn: drop_1675843967,
        },
        1675843967,
    );
    mgr.regist_struct_meta(
    ...
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_env::Args"),
            drop_fn: drop_1694133887,
        },
        1694133887,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_env::EnvVars"),
            drop_fn: drop_591726708,
        },
        591726708,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("Arc<sinfo::StructInfo>"),
            drop_fn: drop_1846921536,
        },
        1846921536,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_async::AsyncRequestHandler"),
            drop_fn: drop_259136547,
        },
        259136547,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("Arc<js_async::AsyncRequestHandler>"),
            drop_fn: drop_374659923,
        },
        374659923,
    );
    mgr.regist_struct_meta(
    ...
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_lib::Nobjs"),
            drop_fn: drop_1422904849,
        },
        1422904849,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_lib::JSGray"),
            drop_fn: drop_2566315655,
        },
        2566315655,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("Arc<RwLock<gray::GrayTab<js_lib::JSGray>>>"),
            drop_fn: drop_3386914360,
        },
        3386914360,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("guid::GuidGen"),
            drop_fn: drop_1736136244,
        },
        1736136244,
    );
    mgr.regist_struct_meta(
    ...
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_net::NetMgr"),
            drop_fn: drop_2462173101,
        },
        2462173101,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_net::TlsNetMgr"),
            drop_fn: drop_4120821321,
        },
        4120821321,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_net::NetHandler"),
            drop_fn: drop_1707332364,
        },
        1707332364,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_net::TopicHandler"),
            drop_fn: drop_15779622,
        },
        15779622,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_net::NetEventHandler"),
            drop_fn: drop_2899437702,
        },
        2899437702,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_net::RequestHandler"),
            drop_fn: drop_4208533229,
        },
        4208533229,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("rpc_tmp::server::RPCServer"),
            drop_fn: drop_3913457295,
        },
        3913457295,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_net::QoS"),
            drop_fn: drop_2688700187,
        },
        2688700187,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("Arc<mqtt_tmp::session::Session>"),
            drop_fn: drop_717646231,
        },
        717646231,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("Arc<js_net::TopicHandler>"),
            drop_fn: drop_3776892844,
        },
        3776892844,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("Arc<base::service::BaseService>"),
            drop_fn: drop_1562130667,
        },
        1562130667,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("Arc<rpc::service::RpcListener>"),
            drop_fn: drop_619541818,
        },
        619541818,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("Arc<rpc::connect::RpcConnect>"),
            drop_fn: drop_3092548949,
        },
        3092548949,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("hotfix::GrayMgr"),
            drop_fn: drop_3355816649,
        },
        3355816649,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("Arc<Mutex<hotfix::GrayMgr>>"),
            drop_fn: drop_579352454,
        },
        579352454,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("hotfix::GrayMgrMutax"),
            drop_fn: drop_646865374,
        },
        646865374,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("webshell::WebShell"),
            drop_fn: drop_937567010,
        },
        937567010,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_net_rpc_client::RPCClient"),
            drop_fn: drop_4088898725,
        },
        4088898725,
    );
    mgr.regist_struct_meta(
        StructMeta {
            name: String::from("js_net_rpc_client::CloseHandler"),
            drop_fn: drop_4288401962,
        },
        4288401962,
    );
